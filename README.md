...
3. Un filtre optionnel restreint aux **Incontournables** (artistes contemporains) ou aux **Classiques** — basé sur l'étiquette `ere` de l'artiste (Deezer ne fournit pas la date de sortie).
